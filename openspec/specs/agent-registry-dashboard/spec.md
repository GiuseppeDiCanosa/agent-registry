---
targets:
  - scripts/webapp/main.py
  - scripts/webapp/static/index.html
---

# agent-registry-dashboard Specification

## Purpose
La dashboard è il punto in cui lo stato del registry si legge senza aprire un
terminale. Questa capability governa ciò che la dashboard espone all'utente
per configurare il registry, a partire dal setup del multi-macchina: la
condizione in cui la proposta compare, l'endpoint che la esegue e l'esito che
la UI deve mostrare, conferme comprese.
...
**Verified by**: [@test] tests/test_webapp.py
