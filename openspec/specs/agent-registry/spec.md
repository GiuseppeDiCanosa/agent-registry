...
## Purpose
Mantenere lo stato condiviso e osservabile degli agenti AI CLI attivi su un progetto — chi
lavora, su cosa, quali file sono bloccati, quali handoff esistono — in un documento
leggibile insieme da umani e da macchine. Gli aggiornamenti arrivano da processi distinti
e simultanei, quindi la capability deve garantire che nessuno di essi vada perso: l'intero
ciclo di lettura-modifica-scrittura è serializzato, e il lock che lo protegge vive su un
file dedicato che non viene mai sostituito, distinto dal file che viene riscritto.
